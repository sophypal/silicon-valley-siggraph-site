...
{block name=content_document}
	...
	<div class="content">
			<form method='post' action='{$smarty.config.WEB_ROOT}/index.php?action=news/add'>
				<fieldset>
				<p>
				...
				<p>
					...
					<textarea name="excerpt">{if isset($news)}{$news.article|nl2br}{/if}</textarea>
				</p>
              	<p>
				...
				<p>
					<label>Article:</label>
					<textarea name="article">{if isset($news)}{$news.article|nl2br}{/if}</textarea>
                </p>
					<p>
